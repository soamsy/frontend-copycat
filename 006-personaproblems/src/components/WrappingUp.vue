<template>
    <div class="p-20 bg-content-bg text-content-fg text-lg">
        ...
        <p class="text-sm relative">
            ...
            Keeping in mind that a lack of subtitles isn't a problem only for
            people who prefer Japanese voicing—anyone who has hearing loss is
            affected, regardless of their language settings. And roughly one in
            five people has hearing loss of some form.
        </p>
    </div>
</template>