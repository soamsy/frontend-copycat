<template>
    <div class="mt-14 p-3 bg-content-bg text-content-fg lg:rotate-2 relative">
        <div class="absolute px-2 py-3 top-[-1rem] right-0 rotate-3 pin-number">#1</div>
        <h2 class="mb-6 text-4xl font-extrabold tracking-wide text-content-highlight">
            Wh<span class="rl-highlight rotate-[4deg]">a</span>t is <span class="rl-highlight rotate-[3deg]">t</span>ransl<span class="rl-highlight rotate-[-2deg]">a</span>tion?
        </h2>
        <div class="m-16 mt-1 lg:rotate-[-2deg] text-lg leading-snug relative">
            ...
            <ul class="px-6 py-4 ml-5">
                <li class="p-bullet-red">Adapting text from one language to another</li>
                <li class="p-bullet-red">Ensuring that the adapted text is faithful to the creator's intent</li>
