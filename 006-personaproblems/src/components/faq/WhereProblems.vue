<template>
    <div class="mt-14 p-3 bg-content-bg text-content-fg lg:rotate-[-1deg] relative">
        <div class="absolute px-2 py-3 top-[-1rem] right-0 rotate-[-2deg] pin-number">#5</div>
        <h2 class="mb-6 text-4xl font-extrabold tracking-wide text-content-highlight">
            W<span class="rl-highlight rotate-[-[2deg]">h</span>ere are th<span class="rl-highlight rotate-[2deg]">e</span> pro<span class="rl-highlight rotate-[4deg]">b</span>lems?
        </h2>
